...
@router.get('')
async def get_all_hospitals(from_: int | None = None, count: int | None = None):
...
@router.post('')
async def add_new_hospital(name: str, address: str, contactPhone: str, rooms: list[str]):
...
async def update_hospital_data(hospital_id: int, name: str, address: str, contactPhone: str, rooms: list[str]):
